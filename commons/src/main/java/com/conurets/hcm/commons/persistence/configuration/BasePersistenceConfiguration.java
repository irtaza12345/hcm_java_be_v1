package com.conurets.hcm.commons.persistence.configuration;
...
@EnableJpaRepositories(basePackages = "com.conurets.hcm.commons.persistence")
public class BasePersistenceConfiguration {
    @Autowired
    private Environment environment;
    private String schema = "public";
    private String[] entityPackageName = new String[]{
            "com.conurets.hcm.commons.persistence.entity",
    };
